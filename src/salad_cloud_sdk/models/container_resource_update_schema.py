...
class ContainerResourceUpdateSchema(BaseModel):
    ...
    :param cpu: The number of CPU cores to allocate to the container (between 1 and 1024)., defaults to None
    :type cpu: int, optional
    :param memory: The amount of memory to allocate to the container in megabytes (between 1024 and 1073741824)., defaults to None
        ...
        **kwargs
        ...
        if shm_size is not SENTINEL:
            self.shm_size = self._define_number(
                "shm_size", shm_size, nullable=True, ge=64, le=1073741824
            )
        self._kwargs = kwargs
