...
class ContainerHttpLoggingConfigurationFormat1(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ContainerHttpLoggingConfigurationFormat1._member_map_.values(),
            )
        )


class ContainerHttpLoggingConfigurationCompression1(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ContainerHttpLoggingConfigurationCompression1._member_map_.values(),
            )
        )
...
class ContainerLoggingConfigurationHttp1(BaseModel):
    ...
    :type format: ContainerHttpLoggingConfigurationFormat1
    ...
    :type compression: ContainerHttpLoggingConfigurationCompression1
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.format = self._enum_matching(
            format, ContainerHttpLoggingConfigurationFormat1.list(), "format"
        )
        self.headers = self._define_list(headers, ContainerLoggingHttpHeader)
        self.compression = self._enum_matching(
            compression,
            ContainerHttpLoggingConfigurationCompression1.list(),
            "compression",
        )
        self._kwargs = kwargs
