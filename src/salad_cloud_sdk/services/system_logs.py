...
from ..models import ProblemDetails, SystemLogList


class SystemLogsService(BaseService):
    ...
    def get_system_logs(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/organizations/{{organization_name}}/projects/{{project_name}}/containers/{{container_group_name}}/system-logs",
                [self.get_api_key()],
            )
        ...
        return SystemLogList._unmap(response)
